  ...
  return (
    ...
    <div className="w-full min-h-[90vh]">
        <div className='text-white text-2xl md:text-4xl text-center mt-9'>
          <h1 className='font-semibold'>I am <span className='text-teal-500 text-bold'>MERN</span> Developer <br /><span>Create Full-Stack<span className='text-teal-500'> Responsive Sites</span> </span></h1>
        </div>
        ...
        <div className="flex flex-wrap gap-9 justify-center  mt-9 pb-9">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className='w-[250px] rounded-xl overflow-hidden bg-[#333]'
              key={index}>
